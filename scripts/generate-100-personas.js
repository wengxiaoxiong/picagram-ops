...
console.log("# 批量插入 100 个 Persona 记录");
console.log("");
...
personas.forEach((p, i) => {
  ...
  console.log(`echo "插入 ${idx}/100: ${p.name}"`);
  console.log(`lark-cli base +record-upsert --base-token ${baseToken} --table-id ${tableId} --fields '${fields}'`);
